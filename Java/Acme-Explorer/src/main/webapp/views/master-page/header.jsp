	...
	<ul id="jMenu">
		...
		<security:authorize access="hasRole('ADMIN')">
			<li><a class="fNiv"><spring:message	code="master.page.administrator" /></a>
				<ul>
					...
					<li><a href="suspicious/administrator/list.do"><spring:message code="master.page.administrator.suspicious" /></a>					
				</ul>
			</li>
		...
		<security:authorize access="hasRole('RANGER')">
			<li><a class="fNiv"><spring:message	code="master.page.ranger" /></a>
				<ul>
					<li class="arrow"></li>
					<li><a href="curriculum/ranger/create.do"><spring:message code="master.page.ranger.curriculum.create" /></a></li>
					<li><a href="curriculum/ranger/edit.do"><spring:message code="master.page.ranger.curriculum.edit" /></a></li>
				</ul>
			</li>
		</security:authorize>
		...
		<security:authorize access="hasRole('AUDITOR')">
			<li><a class="fNiv"><spring:message	code="master.page.auditor" /></a>
				<ul>
					<li class="arrow"></li>
					<li><a href="note/list.do"><spring:message code="master.page.auditor.my.note.list" /></a></li>
		...
		<security:authorize access="isAnonymous()">
			<li><a class="fNiv" href="finder/search.do"><spring:message code="master.page.searchTrip" /></a></li>
			...
			<li><a class="fNiv" href="auditor/create.do"><spring:message code="master.page.auditor.register" /></a></li>
		...
		<security:authorize access="hasRole('EXPLORER')">
			<li><a class="fNiv" href="finder/explorer/search.do"><spring:message code="master.page.searchTrip" /></a>
				<ul>
					<li class="arrow"></li>
					<li><a href="finder/explorer/list.do"><spring:message code="master.page.listSearchTrip" /></a></li>
				</ul>
			</li>
