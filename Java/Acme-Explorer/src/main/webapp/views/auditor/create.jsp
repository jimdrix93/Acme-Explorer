...
<form:form action="auditor/create.do" modelAttribute="auditor" onsubmit="return phoneRegex(this)" method="post">
	<form:hidden path="id" />
	...
	<form:label path="userAccount.username">
		<spring:message code="auditor.userAccount.username" />
	</form:label>
	...
	<form:label path="userAccount.password">
		<spring:message code="auditor.userAccount.password" />
	</form:label>
