...
<form:form action="explorer/create.do" modelAttribute="explorer" onsubmit="return phoneRegex(this)" method="post">
	<form:hidden path="id" />
	...
	<form:label path="userAccount.username">
		<spring:message code="explorer.userAccount.username" />
	</form:label>
	...
	<form:label path="userAccount.password">
		<spring:message code="explorer.userAccount.password" />
	</form:label>
