...
<form:form action="manager/administrator/create.do" modelAttribute="manager" onsubmit="return phoneRegex(this)" method="post">
	<form:hidden path="id" />
	...
	<form:label path="userAccount.username">
		<spring:message code="manager.userAccount.username" />
	</form:label>
	...
	<form:label path="userAccount.password">
		<spring:message code="manager.userAccount.password" />
	</form:label>
